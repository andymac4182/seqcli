...
Start-Process -Wait -FilePath msiexec -ArgumentList '/passive /i ./build/Seq.msi WIXUI_EXITDIALOGOPTIONALCHECKBOX=0 INSTALLFOLDER="C:\Program Files\Seq"' -ShowCall
if ($LASTEXITCODE) { exit 1 }
